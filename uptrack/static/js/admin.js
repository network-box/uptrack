var prepare_list = function(item_type, remove_urlroot, items) {
    if (items.length === 0) {
...
var save_item = function(item, form) {
    var list = $('#uptrack_list');
...
var remove_item = function(item, item_type) {
...
var listitem_clicked = function(elem) {
    /* Set the style */
    $(".uptrack_listitem.uptrack_selected").removeClass("uptrack_selected");
